...
and {\color{red} KY: or doesn't have enough time to interact with disk to change its orientations?} more difficult to be elongated by stratified atmosphere afterward.
...
density, the bubble morphology of two will be similar.{\color{red} KY: The meaning of this sentence is a bit unclear. You mean changing the source density and changing the velocity will give similar results, right?}\
...
but the evolution of bubbles can be slightly accelerated.{\color{red} KY: Is it true that Run B and C look essentially identical even if their jet thermal density is quite different?}
