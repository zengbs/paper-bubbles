...
\label{Methodology}
  ...
  The density profile of \Cref{disc-atm-sys} is shown in Fig. \ref{fig__initial-density-profile}.\
...
\subsection{Morphology and properties of Galactic bubbles}
 ...
 the smooth region (purple band in Fig. \ref{fig__profile}) emitting X-ray\
 ...
 Moreover, the close-up view (right column in Fig. \ref{fig__profile})\
 of profiles and slices (Fig. \ref{fig__innerbubbles})\
 ...
 Also, Fig. \ref{fig__jetI5+ismSeed3-45deg-c,fig__jetI5+ismSeed3-45deg-d}\
 ...
 \end{figure}%
  ...
  Second, as shown in Fig. \ref{fig__jetI5+ismSeed3-45deg},\
...
%  \end{figure*}
 ...
 \begin{figure*}%
      \begin{subfigure}[t]{\textwidth}%
         \centering%
         \includegraphics[width=0.9\textwidth]{figures/fig__xraymap.png}%
         \caption{
               (A) Simulated (top) and observed (bottom; \citealt{Predehl2020}) count rate\
               (photons s$^{-1}$ deg$^{-2}$) in the 0.6--1.0 keV range.\
               Throughout this paper we show sky maps\
               in Galactic coordinates centered on the Galactic center using a Hammer-Aitoff projection,\
               and observed from the solar system.\
      ...
      \begin{subfigure}[t]{\textwidth}%
         \centering%
         \includegraphics[width=0.9\textwidth]{figures/fig__xray-profile-0.8keV-000.png}%
         \caption{
               (B) Comparison of simulated (red) and observed (black; \citealt{Predehl2020}) one-dimensional\
