...
$^{3}$Center for Informatics and Computation in Astronomy, National Tsing Hua University, Hsinchu 30013, Taiwan\\
...
$^{6}$Center for Theoretical Physics, National Taiwan University, Taipei 10617, Taiwan\\
$^{7}$Institute of physics, National Taiwan University, Taipei 10617, Taiwan\\
}
...
include cosmic rays (CRs) and thermal gas, we show that a thin interstellar medium (ISM) disk is a substantial\
...
(3) Followed by the forward shock is a\
hot ($\sim2$ keV), turbulent, and pressure-balanced plasma,\
which we interpret as the \textit{Fermi} bubbles.\
Inside the simulated \textit{Fermi} bubbles,\
there are two additional innermost bubbles we have not detected yet.\
The innermost bubbles are essentially a reverse shock permanently associated with the disk.\
(4) According to the microwave and leptonic gamma-ray spectra, the best-fitting\
CRe power-law index is found to be 2.4.\
The broad agreement between the simulations and observations\
, either from the point of view of their morphology or multiwavelength features,\
...
\subsection{Morphology and properties of Galactic bubbles}
 ...
 The fiducial run (\Cref{fig__jetI5+ismSeed3-45deg-a})\
 ...
 the smooth region (purple band in \Cref{fig__profile}) emitting X-ray\
 ...
 in pressure balance with the external medium.\
 As shown in the temperature or density slices of the fiducial run,\
 the full extent of the turbulent plasma is 9 kpc, fairly close to\
 ...
 The general agreement of extent and temperature\
 suggests that the \textit{Fermi} bubbles\
 is essentially a turbulence rather than a smooth shock \citep{Zhang2020}.

 The most interesting finding is that there are innermost bubbles\
 (dashed box in the top panel of \Cref{fig__jetI5+ismSeed3-45deg-a})\
 ...
 Moreover, the close-up view (right column in \Cref{fig__profile})\
 of profiles and slices (\Cref{fig__innerbubbles})\
 demonstrates that the pressure rises dramatically outward across\
 the edge of the innermost bubbles,\
 ...
 \Cref{fig__jetI5+ismSeed3-45deg} shows the slices of various gas properties at $t=12.39$ Myr,\
 ...
 %To explore how the disk affects the formation of the Galactic bubbles,\
 We compare the clumpy disk (\Cref{fig__jetI5+ismSeed3-45deg-a})\
 with the smooth disc (\Cref{fig__jetI5+ismSeed3-45deg-b}),\
 specified by the initial density profile shown in \Cref{fig__initial-density-profile},\
 ...
 in an uniform atmosphere (\Cref{fig__jetI5+ismSeed3-45deg-c}) is spherical-shape,\
 suggesting the stratification facilitates the outermost bubbles elongation significantly.\
 Also, \Cref{fig__jetI5+ismSeed3-45deg-c,fig__jetI5+ismSeed3-45deg-d}\
...
%  \subfigure[][]%
%    {%
%      \includegraphics[height=10.1cm]{figures/fig__jetI5+ismSeed3-45deg-a}%
%      \label{fig__jetI5+ismSeed3-45deg-a}%
%    }%
%  \hspace{2pt}%
%  \subfigure[][]%
%    {%
%      \includegraphics[height=10.1cm]{figures/fig__jetI5+ismSeed3-45deg-b}%
%      \label{fig__jetI5+ismSeed3-45deg-b}%
%    }%
%  \hspace{2pt}%
%  \subfigure[][]%
%    {%
%      \includegraphics[height=10.1cm]{figures/fig__jetI5+ismSeed3-45deg-c}%
%      \label{fig__jetI5+ismSeed3-45deg-c}%
%    }%
%  \hspace{2pt}%
%  \subfigure[][]%
%    {%
%      \includegraphics[height=10.1cm]{figures/fig__jetI5+ismSeed3-45deg-d}%
%      \label{fig__jetI5+ismSeed3-45deg-d}%
%    }%
%  \caption{
...
%             Comparison between the clumpy (column a)\
%             and the smooth disc (column b) in a stratified atmosphere\
%             shows that the initial density distribution of the dense disc has an insignificant effect\
%             on the overall dynamics of bubbles. However, the outermost bubbles arising from the smooth disc\
%             in an uniform atmosphere (column c) is spherical-shape,\
%             suggesting the stratification facilitates the outermost bubbles elongation significantly.\
%             Also, the two rightmost columns reveal that the development of the innermost bubbles\
%             is always associated with the disc, without the disc (column d),\
%             the outermost bubbles and the turbulent plasma will be oblique,
%             indicating the dense disc is crucial for\
%             the symmetry of the Galactic bubbles and for the innermost bubbles formation.
%  }%
...
%  \subfigure[][]%
%    {%
%      \includegraphics[height=7cm]{figures/fig__profile-1.png}%
%      \label{fig__profile-1}%
%    }%
%  \hspace{2pt}%
%  \subfigure[][]%
%    {%
%      \includegraphics[height=7cm]{figures/fig__profile-2.png}%
...
%             (dashed box in the top panel in \Cref{fig__jetI5+ismSeed3-45deg-a})\
...
%  \begin{figure*}[]
%    \subfigure[(A) Simulated (top) and observed (bottom; \citealt{Predehl2020}) count rate\
...
%     }
%    \subfigure[(B) Comparison of simulated (red) and observed (black; \citealt{Predehl2020}) one-dimensional\
