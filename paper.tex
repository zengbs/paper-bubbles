...
\item The edge of the eROSITA bubbles is a forward shock,\
      originally driven by an inclined bipolar jets that emanated from the GC 12.39 million years ago,\
      and significantly stretched by stratified ambient afterwards.
\item The nature of the \textit{Fermi} bubbles are essentially a turbulent and high-temperature ($\sim1$ keV)\
