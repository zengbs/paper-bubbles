...
%  \citep{BlandHawthorn2016}.
  ...
  \begin{figure}
    ...
    \caption{The volume filling factor as a function of\
             initial number density within the disk without jet source.\
             The vertical bands represent the allowable number densities \citep{peak-ism-density} for\
...
\begin{figure}
  ...
  \caption{
      Simulated gamma-ray spectra (top) of the Fermi bubbles calculated for a longitude range of\
      $|l|<10^{\circ}$ for different latitude bins.\
      The gray band represents the observational data of \citet{Ackermann2014}.\
      Microwave spectra (bottom) averaged over $|l|<10^{\circ}$, $20^{\circ}<|b|<30^{\circ}$.\
