...
\subsection{Inclined jet injection}
  ...
  Note that as we inject the jets within the clumpy disk,\
  ...
  The bipolar jets are constantly and bidirectionally ejected from a cylindrical source\
  with diameter and height of 4 pc, leading to the volume $\sim 50 \text{pc}^{3}$,\
  much smaller than that of individual clump by a factor of 83.\
  By intentionally reducing the ratio of the volume of jet source and of clump,\
  we
  ...
  Source size is much smaller than clump
