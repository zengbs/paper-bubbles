...
\section{Methodology}
  ...
  We model the external and fixed gravity of the Milky Way by prescribing a\
  ...
  is the potential of a plane-parallel isothermal slab.

  The slab is used to mimic the gravity contributed by the stars within the Galactic plane,\
  the  thus

  We mimic the galactic potential by using

  The potential of slab is mainly contributed by the stars within the Galactic center.
