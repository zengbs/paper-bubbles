...
\section{Results}
  ...
  \begin{figure}
    ...
    \caption{
             ...
             the origin for a duration of 1.2 Myr under four different circumstances from left column to right.\
             ...
             on the overall dynamics of the bubbles. However, the outer bubbles with the smooth disk (third)\
             ...
             can only appear with the disk, and without the disk, the outer bubbles will be tilted,
             indicating the dense disk is a crucial component for\
             the formation of the axis-symmetrically outer bubbles and of the most inner bubbles.
             }
