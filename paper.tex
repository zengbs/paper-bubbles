...
\begin{abstract}
A decade ago, the \textit{Fermi Gamma-Ray Space Telescope} reveals two large gamma-ray bubbles in the Galaxy,\
which extend nearly symmetrically $\sim50^{\circ}$ on either side of the Galactic disk.\
The recent discovery of eROSITA bubbles also shows a symmetrically enhanced X-ray\
emission from the shells around the eROSITA bubbles.\
To this end, previous simulation-based works assumed that the jets are vertical to the Galactic disk;\
however, there is a lack of preferred orientation of jets with respect to the Galactic disk.\
Using three-dimensional (3D) special relativistic hydrodynamic simulations that\
include cosmic rays (CRs) and thermal gas, we show that a thin interstellar medium disk is an essential\
component for the symmetry Galactic bubbles.\
...
the oblique jets model. We find that\
(1) The Galactic bubbles are nearly symmetric about the Galactic plane albeit\
the jet is at an angle $45^{\circ}$ with respect to the disc normal.\
(2) The randomness of clumpy disk has a insignificant impact on the overall dynamic of the Galactic bubbles.\
...
\label{Methodology}
  ...
  as we have assumed $p_{\text{cr}}\ll p_{\text{gas}}$ in this paper.\
...
\section{Conclusions}
\label{Conclusions}
In this work, we introduce a thin, dense disk composed of clumpy interstellar medium\
...
\item The edge of the eROSITA bubbles is a forward shock,\
      ...
      We will leave shock-accelerated CRs as a future study.
