...
\section{Methodology}
  ...
  we can write the steady-state gaseous density distributions of disk and the Galactic atmosphere\
  ...
  \Cref{density-profile} shows the initial density profile of hot halo for the simulation presented here.\
  ...
  A crucial ingredient in the simulations is the clumpy ISM disk,\
  in which the temperature ranging from
