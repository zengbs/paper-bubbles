...
The CRe spectrum follows a power law distribution with a spectral index 2 and ranges from\
...
Since the ISRF is dominated by the cosmic microwave background (CMB)\
at high latitudes and optical starlight at low latitudes,\
...
To evaluate the simulated photon flux at the energy $\epsilon_{1}$ and\
take into account the perspective projection effect,
we integrate the emissivity along line-of-sights from the solar position:
\begin{equation}
