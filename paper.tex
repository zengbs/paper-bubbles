...
\item Clumpy cold disk:
  \begin{enumerate}
    \item Dimension: $14\times14\times0.2$ kpc. i.e. Scale heght $=z_{0}=100$ pc. \citep{paek-ism-density}
    ...
    \item The clumpy disk is constructed by multiplying a fractal cuboid with \Cref{disk-density}.
