...
\section{Results}
 ...
 the pressure (top), temperature (middile), number density (bottom) of the $x=0$ slices\
 passing through the bipolar jet source injecting along $z=-y$ direction\
 ...
 Also, the two rightmost columns indicate that the development of the innermost bubbles (dashed box)\
 ...
 the axis-symmetry of bubbles and for the innermost bubbles formation.
