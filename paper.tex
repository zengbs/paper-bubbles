...
$\dagger k_{\text{min}}$                                             & Cutoff wave number                        & 375.0                                \\
$\mu_{\text{clumpy}}$                                        & Mean of scalar field                      & 1.0                                  \\
$\sigma_{\text{clumpy}}$                                     & Dispersion of scalar field                & 1.7                                  \\ % RELATIVISTIC JET FEEDBACK IN EVOLVING GALAXIES Wagner (2011)
