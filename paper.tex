...
\subsection{Morphology}
 ...
 % the forward shock
  ...
  First, the broad agreement between simulated and observed X-ray map hint that\
  the symmetric eROSITA bubbles can be properly formed by an inclined jet within a thin disk\
  of dense interstellar medium.\


  Second, as shown in \Cref{fig__jetI5+ismSeed3-45deg_no-disc-stratified-ambient-Pres-Dens-Temp},\
  ...
  We therefore suggest that the nature of eROSITA bubbles is indeed a forward shock\
  propagating through the halo gas, as previously proposed by \citet{Predehl2020}.



% 2. North Polar Spur is not shown as it is a supernova remanent near us.
  Third, the innermost bubbles, even though with high column density, is invisible in the simulated X-ray map as\
  the temperature of innermost bubbles is around $1$ -- $10$ eV\
  (see the temperature slice in \Cref{fig__jetI5+ismSeed3-45deg_no-disc-stratified-ambient-Pres-Dens-Temp}).\
