...
\subsection{Morphology}
 ...
 the symmetry of the Galactic bubbles and for the innermost bubbles formation.
  ...
  along lines of sight across the sky.
...
In the leptonic scenario, the gamma-rays originate from IC scattering of the interstellar radiation field by CRe.\
...
$n(\epsilon)$ the photon number density of interstellar radiation field per energy, $\gamma$ the Lorentz factor of CRe,\
...
on the simulated CR number density and the interstellar radiation field model given by \citet{Porter2017}.
...
% so it's more likely associated with turbulence.
  ...
  %the high-latitude spectrum tends to be dimmer because of the decay of the interstellar radiation field intensity in optical.
