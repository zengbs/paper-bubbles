...
\subsection{Morphology and properties of Galactic bubbles}
 ...
 The fiducial run (leftmost column) specified in Section \ref{Methodology}\
 shows that the edge of the outermost bubbles is indeed a forward shock,\
 expanding roughly 12.5 kpc above and below the Galactic plane,\
 and with a radius of about 6.8 kpc along the plane.\


 \Cref{fig__profile} shows the profiles cut at the positive z-axis in \Cref{fig__jetI5+ismSeed3-45deg}.\
 The temperature profile indicates that most of the region between the forward shock and the turbulent region\
