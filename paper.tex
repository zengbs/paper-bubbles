...
\section{Methodology}
  ...
  We tabulate parameters in the \textbf{Isothermal disk} and \textbf{Atmosphere}\
  categories in \Cref{table-parameters},\
...
$\mu_{\text{clumpy}}$                                 & Mean of number density                    & 1.0 $\text{cm}^{-3}$                 & \citet{Wagner2012}              \\
$\sigma_{\text{clumpy}}$                              & Dispersion of number density              & 1.7 $\text{cm}^{-3}$                 & \multicolumn{1}{c}{''}          \\
