...
\section{Methodology}
  ...
  of the bulge and atmosphere on the $z=0$ plane.
...
$d_{\text{h}}$                      & Core radius                       & 12 kpc                               & \citep{Johnston1995}              \\ \hline
{\bf Atmosphere}                    &                                   &                                      &                                   \\
...
$\rho_{\text{disk}}^{\text{peak}}$  & Peak mass density of disk         & $10^{-23}$ g/cm$^{3}$                & \citep{peak-ism-density}          \\ \midrule
\end{tabular}
\end{table*}
