...
\subsection{Morphology and properties of Galactic bubbles}
 ...
 The temperature profile (left column of \Cref{fig__profile}) along the positive z-axis in\
 ...
 suggesting that the outer edge of the \textit{Fermi} bubbles\
 ...
 Moreover, the close-up view of profiles around $z=3.7$ kpc (right column of \Cref{fig__profile})
 ...
 we compare the fiducial run (first column from left)\
 with the case with the smooth disc (second) in a stratified atmosphere.\
