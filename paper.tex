...
\begin{enumerate}
  \item Numerical features:
    \begin{enumerate}
      ...
      \item Using a new algorithm \citep{tseng2021} dedicated to the conversion between primitive and conserved variable,\
            significantly reducing numerical error caused by catastrophic cancellation occurs\
            within the non-relativistically cold disk.
    \end{enumerate}
  ...
  \item Assumptions on gravity:
    \begin{enumerate}
      ...
      \item The ISM disk and atmosphere are subjected to the fixed external potential\
            contributed by disk bulge and dark matter halo.
