...
hot bubbles. Subsequent buoyancy in the stratified atmosphere renders them vertical to form
...
\label{Methodology}
  ...
  \begin{subequations}
    ...
    \begin{align}
     ...
     -p_{\text{cr}} \partial_{j} U^{j},\\
     &\partial_{i}\partial^{i}\Phi=4\pi G \rho,
    \label{E evolution}
    \end{align}
  \end{subequations}
  ...
  $\Phi$ is a gravitational potential, and $G$ is the gravitational constant.\
 ...
 \begin{figure}%
     ...
     \end{subfigure}%
      \caption{
             ...
             on the overall dynamics of bubbles. However, the outermost bubbles arising from the smooth disk\
             in a uniform atmosphere (Fig. \ref{fig__jetI5+ismSeed3-45deg-c}) are nearly spherical,\
...
\item Downstream of the reverse shock is filled with hot ($\sim2$ keV) and highly turbulent
      ...
      the instabilities at the bubble surface due to the magnetic draping effect.
