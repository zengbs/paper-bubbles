...
%  when the cell temperature beyond the critical value $T_{\text{crit}}$.
  ...
  We also restrict the refinement level is 7 within the cold disk so that\
...
\subsection{Jet injection}
  The core of this work is to release the caveat that the jet direction must be perpendicular to the Galactic plane.\
