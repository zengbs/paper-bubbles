...
\begin{enumerate}
  \item Numerical features:
    \begin{enumerate}
      ...
      \item Using a new algorithm \citep{tseng2021} dedicated to the conversion between\
            primitive and conserved variable, significantly reducing\
            numerical error caused by catastrophic cancellation occurs frequently\
