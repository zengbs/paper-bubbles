...
\label{Methodology}
  ...
  and assuming the interfaces between the disc and atmosphere are in thermal pressure equilibrium,\
  ...
  $T_{\text{isoDisk}}$ and $T_{\text{atmp}}$ is the temperature of the disc and atmosphere,\
...
%  \citep{BlandHawthorn2016}.
  ...
  \begin{figure}
    ...
    \caption{The density profile of the disc (red pluses) and\
...
\subsection{Inclined jet injection}
  ...
  the smooth disc on the mid-plane $z=0$ (i.e. $\rho^{\text{peak}}_{\text{isoDisk}}$),\
