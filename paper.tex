...
In this section, we present the simulation results using exactly same parameters\
except for the density ($\rho$), temperature ($k_{B}T$),\
and four-velocity ($\beta\gamma$) within the jet source.\
These variable parameters, including the fiducial run (C), are\
tabulated in Table \ref{tablb-jet-parameters} and visualized in Fig. \ref{fig__jet_parameters}.
...
$\beta\gamma$     & 1.2        & 0.6        & 0.6        & 0.6         & 0.6        & 0.6        & 0.3        \\ \midrule
\end{tabular}
\end{table*}
