...
\section{Results}
  ...
  \begin{figure}
    ...
    \caption{
             Comparison between the case with a clumpy (first column from left)\
             ...
             suggesting the stratification facilitate bubbles elongation.\
             The rightmost column shows that the bubbles without disk is tilted even\
             in the stratified atmosphere, indicating dense disk is a crucial component\
             for axis-symmetric bubbles formation.\
             In all cases, bipolar jets are injected at the origin along $z=-y$ direction\
             for a duration of 1.2 Myr.
             The pressure (top), temperature (middle), and number density (bottom) slices\
             through jet sources show that the under pressure, cold, and dense bubbles (dashed box)\
             only appear if disk is present.
             }
