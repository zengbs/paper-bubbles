...
\item The elapsed time of 12.39 Myr required for the simulated bubbles
      ...
      high energy ($\sim100$ GeV) CRe. Thus, re-acceleration of CRe must be considered
      in this model. As opposed to shock acceleration,
      the acceleration of CRe that can compete with IC and synchrotron cooling
      may be dominated by the stochastic acceleration associated with the Galactic magnetic field,
      since the forward shock is rather far away from the gamma-ray bubbles.
