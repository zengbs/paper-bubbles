...
\end{figure*}
 ...
 Finally, the comparison between \Cref{fig__jetI5+ismSeed3-45deg-CR} and\
 \Cref{fig__jetI5+ismSeed3-45deg} shows that the CR pressure\
 is around 5$\times10^{-15}$--8$\times10^{-15}$ erg/cm$^{3}$, less than the gas pressure by a factor 10--20.\
 We thefore stress that in \Cref{governing-eq},\
 assuming $p_{CR}\ll p_{\text{gas}}$ is resonable.
