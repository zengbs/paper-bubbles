...
\subsection{Morphology and properties of Galactic bubbles}
 ...
 we compare the fiducial run (panels a1-a3 in \Cref{fig__jetI5+ismSeed3-45deg})\
 with the case adopting the smooth disc\
 (panels b1-b3; \Cref{fig__initial-density-profile} shows the density profile) in a stratified atmosphere.\
 ...
 in an uniform atmosphere (panels c1-c3) is spherical-shape,\
