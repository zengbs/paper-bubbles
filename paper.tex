...
\begin{subequations}
  ...
  \begin{align}
   ...
   &\partial_{t} \left(\gamma e_{\text{cr}}\right) + \partial_{j} \left(e_{\text{cr}}U^{j}\right)=-p_{\text{cr}}\left(\frac{\partial\gamma}{\partial t} + \frac{1}{c}\partial_{j} U^{j}\right),\label{D evolution}
  \end{align}
\end{subequations}
...
$p_{\text{cr}}$ and $e_{\text{cr}}$ are the CR pressure and CR energy density. \
