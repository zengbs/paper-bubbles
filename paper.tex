...
\subsection{Morphology and properties of Galactic bubbles}
 ...
 The full extent of the hot plasma is approximately agree with the observation \citep{Su2010}.
 Also, the temperature of the plasma is high as 2 keV, comparable to that of the \textit{Fermi} bubbles\
 ...
 % pressure balance, contact discontinuity

 % which we will interpret as the \textit{Fermi} bubbles.\
