...
\citet{Jones1968,BLUMENTHAL1970}.

\begin{subequations}
  \begin{align}
  &\frac{dE}{dtd\epsilon_{1}dV} =\nonumber\\
               &\frac{3}{4}\sigma_{T}c\textit{C}\epsilon_{1}\int^{\epsilon_{\text{max}}}_{\epsilon_{\text{min}}}
...
where $\gamma_{\text{min}}(\epsilon)$ and $\gamma_{\text{max}}=10^{6}$\
are the minimum and maximum Lorentz factor of CRe,\
$n(\epsilon)$ is the photon number density of ISRF per energy,
