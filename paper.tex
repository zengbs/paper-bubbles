...
\section{Methodology}
  ...
  As a proof-of-concept study, we approximate conventionally axisymmetric potential of Milky Way\
  ...
  is the potential of a isothermal slab mainly contributed by stars within the Galactic plane.
  ...
  the steady-state gaseous density distribution in a total potential, $\Phi_{\text{total}}$,\
  can be written as
  \begin{equation}
     \rho(z)=
     \begin{cases}
  ...
  All parameters are listed in \Cref{table-parameters}, excpet for $\rho_{\text{atmp}}^{\text{peak}}$ that\
  can be derived from the pressure equilibrium on the interfaces ($|z|=z_{0}$) between disk and atmosphere.
...
$\rho_{\text{disk}}^{\text{peak}}$  & Peak mass density of disk         & $10^{-23}$ g/cm$^{3}$                & \citep{peak-ism-density}          \\ \hline
{\bf Atmosphere}                    &                                   &                                      &                                   \\
...
$d_{\text{h}}$                      & Core radius                       & 12 kpc                               & \citep{Johnston1995}              \\ \midrule
\end{tabular}
\end{table*}
