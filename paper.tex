...
Potential \& halo                   &                               &                               \\
$\sigma_{\text{bulge}}$             & Velocity dispersion of bulge  & 100 km/s                      \\
$\rho_{\text{bulge}}^{\text{peak}}$ & Peak average density of bulge & $4\times 10^{-24}$ g/cm$^{3}$ \\
$v_{\text{halo}}$                   &                               & 131.5 km/s                    \\
$d_{\text{h}}$                      &                               & 12 kpc                        \\
Atmosphere                          &                               &                               \\
$T_{\text{\text{atmp}}}$            &                               & $10^{6}$ K                    \\
Disk                                &                               &                               \\
$z_{0}$                             & Scale height of disk          & 100 pc                        \\
$\rho_{\text{disk}}^{\text{peak}}$  & Peak number density of disk   & $6\text{ c.c.}^{-1}$          \\
$T_{\text{\text{disk}}}$            & Temperature of disk           & $10^{3}$ K                    \\ \bottomrule
\end{tabular}
\end{table*}
