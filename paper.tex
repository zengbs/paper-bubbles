...
\subsection{Morphology and properties of Galactic bubbles}
 ...
 demonstrates that there is a sharp pressure jump at $z=3.62$ kpc,\
 indicating that the pressure jump is an expanding reverse shock.\
 The high density upstream of the reverse shock requires\
 an even higher density downstream, i.e. a dense shell formation.\
 Continuing outward, the higher density must match with low density further downstream;\
 thus there exists a contact discontinuity ($z=3.75$ kpc).
 ...
 The small contact discontinuity, CD, is interesting in its own way\
 but not a major event to alter the overall large scale structure of the flow.\
