...
\item The edge of the eROSITA bubbles is a forward shock,\
      ...
      and stretched by stratified ambient subsequently.
\item The nature of the \textit{Fermi} bubbles are essentially a turbulent flows\
      that can stochastically accelerate CRe. Associated with
