...
The gamma-ray emission of the Fermi bubbles is observed in the energy range\
...
Early attempts to model the Fermi and eROSITA bubbles (collectiely we call the Galactic bubbles)\
assumed that the jet is vertial to the Galactic plane. However,\
...
To this end, this work introduces a dense thin disk of interstellar medium\
around a jet source, in an attempt to remedy the symmetry problem of the Galactic bubbles.\
The thin disk contains a reservoir of dense molecular/atomic gas, resulting in\




We perform three-dimensional special relativistic hydrodynamics simulations\
of the formation of the Galactic bubbles by CR jet injections\
from the central SMBH in the Galaxy.
