...
{\color{blue} PH: Thanks! I have added this point to the text above.}


{\color{red} KY: The meaning of this sentence is a bit unclear. You mean changing the source density and changing the velocity will give similar results, right?}
{\color{blue} PH: I have deleted the unclear sentence since I feel it is pointless.}
...
the jets cannot effectively ablate the high-density cloud within 12.39 Myr,
resulting in the formation of asymmetrical bubbles (the run B).


{\color{red} KY: Is it true that Run B and C look essentially identical even if their jet thermal density is quite different?}
{\color{blue} PH: Yes. To make the difference more obvious,
I have expanded the temperature range by a factor of 5. i.e. $T_{D}/T_{C}=T_{C}/T_{B}\sim50$.}
