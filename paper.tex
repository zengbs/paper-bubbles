...
\section{Methodology}
  ...
  \begin{figure}
    \includegraphics[width=1.0\linewidth]{figures/fig__initial-density-profile.png}
    \caption{The profile of $\rho_{\text{isoDisk}}(z)$ along z-axis.}
  ...
  \begin{figure}
      \includegraphics[width=1.0\linewidth]{figures/fig__numberDensityHistogram.png}
      \caption{The initial density distribution of the number density\
               for a settling ISM without jet source.} % caption
      \label{fig__numberDensityHistogram}
  \end{figure}

  \begin{figure}
    \includegraphics[width=1.0\linewidth]{figures/fig__zoom-in-disk.png}
    \caption{The slice of pressure (top), temperature (middle), and number density (bottom)\
             in the y-z plane passing through the center of the disk.}
    \label{fig__zoom-in-disk.png}
  \end{figure}
...
facilitate a reliable interpretation.
