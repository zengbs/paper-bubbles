...
The \textit{Fermi} bubbles, two giant bubbles extending about 50 degrees above and below the Galactic center (GC),\
...
$m_{\text{e}}c^2$ ($0.5$ MeV) to $1.1\times10^{6}m_{\text{e}}c^2$ ($0.55$ TeV).\
...
\begin{figure*}
  ...
  \caption{The observed (left) and simulated (right) photon flux at 108.6 GeV.\
           ...
           photon flux of the diffuse component reconstructed by the D$^3$PO algorithm \citep{Selig2015} that analyzes\
