...
\subsection{X-ray}
The X-ray emissivity in an energy range 1.4–1.6 keV is calculated\
...
Since the jets encounter a larger column depth of cloudsalong their path,\
