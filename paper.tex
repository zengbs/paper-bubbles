...
\section{Results}
  ...
  \begin{figure}
    ...
    \caption{
             ...
             shows that the initial density distribution of the dense disk has insignificant effect\
...
follows out to a radius of 250 kpc the observed density profile of \citep{temperature-MW}.
  ...
  %\begin{figure*}[ht]
  \begin{figure*}
    \subfigure[(Reproduced with permission from R. Blatt, Rev. Mod. Phys. 87, 1419 (2015).\
               Copyright 2015 American Physical Society.)\
               Synthetic count rate (photons s$^{-1}$ deg$^{-2}$) in the 0.6-1.0 keV range,\
               using a Hammer-Aitoff projection. Throughout this paper we show sky maps in\
               Galactic coordinates centered on the Galactic center, and the view point .]
     {
...
with a spectral index $p=2.4$ \citep{Selig2015} and ranges from\
...
\begin{figure*}
  ...
  \caption{The observed (left) and simulated (right) photon flux at 1.7 GeV (top), 13.6 GeV (middle), and 108.6 GeV (bottom).\
           Note that the panels on left side are diffuse (i.e. no point-like component)\
           photon flux reconstructed by the D$^3$PO algorithm \citep{Selig2015} that analyze\
