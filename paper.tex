...
\subsection{Morphology}
 ...
 the symmetry of the Galactic bubbles and for the innermost bubbles formation.
  ...
  We point out that the projections employed throughout this paper is \lq perspective\rq,\
  ...
  \Cref{fig__xray_0.8keV_angle_000} shows the projected X-ray emissivity from simulation,\
  overlaid with the red arrow representing the direction of the bipolar jet,\
  constantly ejecting during 0--1.2 Myr at an angle of $45^{\circ}$\
  to the disc normal.
