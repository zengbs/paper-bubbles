...
\section{Methodology}
  ...
  the steady-state gaseous density distribution of disk and atmosphere\
  confined in the total potential, $\Phi_{\text{total}}$,\
  can be written as
  \begin{equation}
     \rho(z)=
     \begin{cases}
  ...
  of the bulge and atmosphere on the mid-plane $z=0$.

  All parameters are listed in \Cref{table-parameters}, excpet for $\rho_{\text{atmp}}^{\text{peak}}$ that\
  can be derived from the known parameters and pressure equilibrium\
