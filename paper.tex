...
two large bubbles symmetrically extending about 50 degrees above and below the Galactic center,
...
symmetrically extending about 80 degress above and below GC.

The large-scale X-ray structure\
shows that the intrinsic size of the bubbles is 14 kiloparsecs across \citep{Predehl2021},
and has remarkable morphological symmetry about the Galactic plane as the Fermi bubbles.
...
Early attempts to model the Fermi and eROSITA bubbles (collectiely we called the Galactic bubbles)\
assumed that the jet is vertial to the Galactic plane...
