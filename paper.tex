...
\section{Methodology}
  ...
  \begin{equation}
     \rho(z)=
     \begin{cases}
     \displaystyle\rho_{\text{bulge}}^{\text{peak}}
     \exp\left[-\frac{\Phi_{\text{total}}}{k_{B}T_{\text{bulge}}/m}\right] & \text{, if $|z| < z_{0}$,}\\
  ...
  where $\rho_{\text{bulge}}^{\text{peak}}$ and $\rho_{\text{atmp}}^{\text{peak}}$ is the mass density\
...
$T_{\text{\text{atmp}}}$            &                               & $10^{6}$ K                           & \citep{temperature-MW}            \\
{\bf Disk}                          &                               &                                      &                                   \\ \cmidrule(r){1-1}
$z_{0}$                             & Scale height of disk          & 100 pc                               &                                   \\
		$\rho_{\text{disk}}^{\text{peak}}$  & Peak number density of disk   & $6\text{ c.c.}^{-1}$ & \citep{peak-ism-density}          \\
$T_{\text{\text{disk}}}$            & Temperature of disk           & $10^{3}$ K                           &                                   \\ \midrule
\end{tabular}
\end{table*}
