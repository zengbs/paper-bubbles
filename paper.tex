...
\subsection{Gamma-ray and microwave emission}
  ...
  The gamma-rays originate from the inverse Compton scattering of ISRF by CRe.\
  ...
  The emissivity of the upscattered photons at the energy $\epsilon_{1}$ is computed for\
  each computational cell in our simulations\
  using the Klein-Nishina IC cross-section \citep{Jones1968,BLUMENTHAL1970}\
  to handle the ultra-relativistic CRe:
...
$\epsilon_{\text{min}}=1.13\times10^{-4}$ eV (cosmic microwave background radiation) to\
