...
%overall dynamic of the Galactic bubbles.
%Furthermore,
In the absence of the disk, only forward shocks are present,
...
\item The edge of the eROSITA bubbles is a forward shock,
      originally driven by bipolar jets emanating from the GC around 12 Myr ago
      for a duration of 1.2 Myr,
      and significantly expanded in the stratified atmosphere afterwards.
      ...
      increasing the compressibility of the fluid and enhancing the thermal Bremsstrahlung emissivity
...
\item Assuming a leptonic model with a spatially uniform, power-law CRe spectrum
      ranging from 0.5 MeV to 562.1 GeV, we showed that the observed gamma-ray and microwave spectra
      can simultaneously reproduced. The best-fit CRe power-law index is found to be 2.4.
\item The elapsed time of 12 Myr is required for the simulated bubbles to reach the desired morphology.
...
\item The Galactic bubbles are nearly symmetric about the Galactic plane albeit\
      ...
      which release the caveat of earlier jet models where jets need to be vertical.
