...
\begin{figure}
  ...
  \caption{
      Simulated gamma-ray spectra (colored lines in top panel) of the Fermi bubbles calculated for a longitude range of\
      $|l|<10^{\circ}$ for different latitude bins.\
      The gray band represents the observational data of \citet{Ackermann2014}.\
      Simulated microwave spectra (colored lines in bottom) averaged over $|l|<10^{\circ}$, $20^{\circ}<|b|<30^{\circ}$.\
