...
\section{Methodology}
  ...
  the log-normal probability distribution \citep{Berkhuijsen2008} with mean $\mu=1.3$ and dispersion $\sigma=0.13$ in real space,\
  ...
  The spectrum $D(k)$ with index $-5/3$ in the Fourier space has the cutoff wave number $k_{\text{min}}=375.0$,\
