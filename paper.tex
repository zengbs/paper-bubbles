...
\subsection{Inclined jet injection}
  ...
  A number of galaxies in which the jets are inclined to the disc normal\
  ...
  The jet duration time is set to 1.2 Myr in the simulations\
  such that the total ejected energy $1.2\times10^{56}$ erg is between\
  $8\times10^{55}$ erg and $1.3\times10^{56}$ erg proposed by \citet{Predehl2020}.\
