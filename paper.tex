...
We find that the simulated gamma-ray spectra are well fitted by\
the CRe spectral index 2.4 (the middle row),\
and display several similar features as observed.

First, the simulated and observed spectra of the \textit{Fermi} bubbles is\
...
Second, the gamma-ray spectra for all latitudes exhibit a spectral cutoff around energies 400--500 GeV,\
...
the relativistic scatterings between the high-energy CRe ($\gtrapprox 408$ GeV)\
