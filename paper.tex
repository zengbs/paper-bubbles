  ...
  \begin{enumerate}
    ...
    \item Density:
          \begin{equation}
             ...
             \exp\left[-\frac{\Phi_{\text{bulge}}}{k_{B}T_{\text{disk}}/m}\right].
             \label{disk-density}
          \end{equation}
  ...
  \begin{enumerate}
     ...
     \item Density:
          \begin{equation}
             ...
             \exp\left[-\frac{\Phi_{\text{bulge}}}{k_{B}T_{\text{atmp}}/m}\right],
             \label{atmosphere-density}
          \end{equation}
          where $\rho_{\text{atmp}}^{\text{peak}}$ can be obtained by assuming that pressure\
          and gravitational potential are continuous at the interface between disk and atmosphere (i.e. $z=\pm z_{0}$).
  \end{enumerate}
