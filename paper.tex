...
to model the symmetric Fermi and eROSITA bubbles (collectively we call the Galactic bubbles)\
...
around a jet source to deflects and decelerates the jets,\
...
whether the jet scenario is able to produce symmetric Galactic bubbles that are\
consistent with the observed features, including the shape, the\
flat surface brightness, and the sharp edges.\
