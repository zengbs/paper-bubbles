...
\begin{enumerate}
  \item Numerical features:
    \begin{enumerate}
      ...
      \item We use a new algorithm \citep{tseng2021} to convert between\
            primitive and conserved variables, significantly reducing\
...
\subsection{X-ray and Gamma-ray emission}
  \begin{enumerate}
    ...
    \item Gamma-ray:
       \begin{enumerate}
         \item Leptonic process: Inverse compton scattering
          The gamma-ray emission is produced by inverse Comptom scattering of the ISRF by CRe.
         \item Hadronic process:pion decay
          In the hadronic model, CRp undergo hadronic collisions with thermal gas protons\
          and produce $\gamma$-ray via pion decay. The volume emissivity of the emission can be writen as
          \begin{equation}
